...
void main() {
  group('Tests of LimitInputFormatter.formatEditUpdate()', () {
    group('Test for [IVS]', () {
      test('Should return [new value] if [old value is empty] and [new value does not exceed the limit]', () {
        ...
        LimitInputFormatter actualLimitInputFormatter = LimitInputFormatter(inputsSum: inputSum, inputWeight: inputWeight);
