...
class CreatorProcessWrapper extends StatefulWidget {
  final MaxIVFormCubit maxIVSlotsAmountCubit = globalLocator<MaxIVFormCubit>();
...
class _CreatorProcessWrapper extends State<CreatorProcessWrapper> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MaxIVFormCubit, AMaxIVFormState>(builder: (BuildContext context, AMaxIVFormState ivTextFormsState) {
