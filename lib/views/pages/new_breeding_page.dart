...
class _NewBreedingState extends State<NewBreedingPage> {
  final NewBreedingCubit _newBreedingCubit = globalLocator<NewBreedingCubit>();
              ...
              body: CustomContainer(
                ...
                columnItems: <Widget>[
                  ...
                  SizedBox(
                    width: 250,
                    child: TextField(
                      controller: _newBreedingCubit.newBreedingModel.newBreedingTextEditingController,
