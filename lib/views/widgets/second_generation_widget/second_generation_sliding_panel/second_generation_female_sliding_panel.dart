...
class _SecondGenerationFemaleSlidingPanelState extends State<SecondGenerationFemaleSlidingPanel> {
  ...
  Widget _buildAttributeButton(String text, Color color, int index) {
    return AttributeValueButton(
      buttonText: text,
      onPressed: () => secondGenerationCubit.getFemaleColors(index),
      buttonColor: color,
      isEnabled: secondGenerationCubit.secondGenerationModel.isFemaleButtonEnable()[index],
    );
  }
    ...
    return Row(
      ...
      children: <Widget>[
        AttributeValueButton(
          ...
          isEnabled: secondGenerationCubit.secondGenerationModel.isFemaleRestartButtonEnabled(),
