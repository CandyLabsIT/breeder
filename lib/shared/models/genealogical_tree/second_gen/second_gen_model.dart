...
class SecondGenModel {
  ...
  void propagateFromParent(SecondGenIndex secondGenIndex, List<IVColor> ivColorList) {
  ...
  Map<SecondGenIndex, bool> setButtonsMap() {
    Map<SecondGenIndex, bool> monsterButtonsMap = secondGenMap.map(
